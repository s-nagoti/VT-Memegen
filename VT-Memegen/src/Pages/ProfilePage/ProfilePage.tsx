...
const ProfilePage: React.FC = () => {
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gray-900">
        <div className="text-center">
          <svg
            className="animate-spin h-12 w-12 text-[#E87722] mx-auto mb-4"
      ...
      <div className="flex justify-center items-center h-screen bg-gray-900">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-4 px-4 py-2 bg-[#861F41] text-white rounded-lg shadow hover:bg-[#621A36] transition-colors duration-200"
          >
            Go to Login
          </button>
        </div>
  ...
  const PostGrid: React.FC<PostGridProps> = ({
    ...
    <div className="flex-1 bg-gray-800 p-6 rounded-lg shadow-md border-t-4 border-[#E87722]">
        ...
        <div className="grid grid-cols-1 gap-6">
          {posts.map((post) => (
            ...
            >
              <div
                key={post.id}
                className="flex flex-col sm:flex-row bg-gray-700 rounded-lg shadow-sm overflow-hidden transition duration-300 ease-in-out hover:shadow-md hover:bg-gray-600"
              >
   ...
   return (
     <div className="min-h-screen bg-gray-900">
       ...
       <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
         <section className="bg-gray-800 rounded-2xl shadow-lg overflow-hidden mb-8 border-t-4 border-[#E87722]">
           <div className="md:flex">
             ...
             <div className="p-8">
               ...
               <p className="mt-2 text-xl text-gray-300">{user.email}</p>
               <div className="mt-6 flex flex-wrap gap-4">
                 <button
                   onClick={handleLogout}
                   className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#861F41] hover:bg-[#621A36] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#861F41]"
                 >
                 ...
                 <button
                   ...
                   className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-[#861F41] bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#861F41]"
                 >
